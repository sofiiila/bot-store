...
from src.new_handlers.order import order, handle_user_message
...
conv_handler = ConversationHandler(
    ...
    states={
        ...
        ORDER: [
            global_handler,
            MessageHandler(filters.TEXT | filters.PHOTO | filters.Document.ALL & ~filters.COMMAND, handle_user_message),
            CallbackQueryHandler(start, pattern="^" + str(START) + "$"),
